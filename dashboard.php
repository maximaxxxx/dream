...
// Tables disponibles
$tables = ['EMOTION', 'LANGUE', 'LIAISON_ELEMENT', 'LIAISON_EMOTION', 'LIAISON_LANGUE', 'LIAISON_TROUBLE_DE_SANTE', 'LIEU', 'PERSONNAGE_PRINCIPAL', 'PEUR', 'REVE', 'REVEUR', 'TROUBLE_DE_SANTE', 'TYPE_ELEMENT_DANS_LE_REVE', 'TYPE_REVE', 'UTILISATEUR'];
